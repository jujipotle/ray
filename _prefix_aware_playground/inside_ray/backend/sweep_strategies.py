...
DEFAULT_CONFIG = {
    ...
    # Benchmark Info
    "benchmark_label": "8_routers_base_strategies",
    ...
    for config_idx, sweep_config in enumerate(sweeps_configs):
        ...
        for strategy in args.scheduler_strategies_dict.keys():
            ...
            try:
                ...
                print("Sleeping for 3 seconds (to allow load distribution to be written to file and for results to be written to csv)...")
                time.sleep(3)
                ...
                print("Sleeping for 10 seconds (to allow server to shut down)...")
