...
class RunningReplica:
    ...
    def _get_replica_wrapper(self, pr: PendingRequest) -> ReplicaWrapper:
        print(
            f"[replica_wrapper.py: RunningReplica: _get_replica_wrapper] Getting actor replica wrapper for {self._actor_handle}"
        )
    ...
    async def send_request(
        ...
        print(
            f"[replica_wrapper.py: RunningReplica: send_request] Sending request to {self._actor_handle}"
        )
        ...
        print(
            f"[replica_wrapper.py: RunningReplica: send_request] Result: {result}, Queue Length Info: {queue_len_info}"
        )
