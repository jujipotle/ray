...
class ReplicaMetricsManager:
    ...
    def inc_num_ongoing_requests(self) -> int:
        ...
        print(f"[replica_metrics_manager.py: inc_num_ongoing_requests] Incremented Queue Length to: {self._num_ongoing_requests}")
    ...
    def dec_num_ongoing_requests(self) -> int:
        ...
        self._num_ongoing_requests -= 1
        print(f"[replica_metrics_manager.py: dec_num_ongoing_requests] Decremented Queue Length to: {self._num_ongoing_requests}")
